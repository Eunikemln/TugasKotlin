 ...
 */
fun myProfile() {
    var namaDepan = "Eunike"
    var namaBelakang = "Tarigan"
    val umur = 20
    val statustrue = "Singel"
    val statusfalse = "Tidak"
    println(namaDepan + " Meulina " + namaBelakang)
    println(umur)
 ...
 */
fun myGroup(): String {
    val groupMembers = listOf("Nike", "Lizzam", "Devita", "Pupu", "Miftahur")
 ...
 */
fun totalMember(): Int {
    val mentor = arrayOf("Reza", "Hasan", "Dian", "Shasa")
    val countOfGroup = 5
...
fun main() {
     ...
     *
     */
    groupDetail(1, listOf("Nike", "Lizzam", "Devita", "Pupu", "Miftahur"), "Afternoon")
